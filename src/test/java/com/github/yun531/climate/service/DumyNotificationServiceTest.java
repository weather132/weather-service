...
//class DumyNotificationServiceTest {
//
//    @Mock
...
//        List<String> out = service.generate(List.of(1), null, t);
//
//        // then
...
//        List<String> out = service.generate(List.of(1, 2), enabled, t1);
//
//        // then
...
//        List<String> out = service.generate(List.of(1), enabled, t);
//
//        // then
//        assertThat(out).hasSize(1);
...
//
//        // when
//        List<String> out = service.generate(List.of(1, 2), enabled, LocalDateTime.parse("2025-11-04T04:00:00"));
//
...
//        List<String> out = svc.generate(List.of(1), enabled, LocalDateTime.parse("2025-11-04T04:00:00"));
//
//        // then
//        assertThat(out).hasSize(1);
...
//        // when
//        Set<AlertTypeEnum> enabled = EnumSet.of(AlertTypeEnum.RAIN_FORECAST);
//        List<String> out = svc.generate(List.of(1, 2, 3), enabled, LocalDateTime.parse("2025-11-04T04:00:00"));
//
//        // then: 3개 지역 각각 한 줄
//        assertThat(out).hasSize(3);
//        assertThat(out.get(0)).isEqualTo("지역 1 | 오늘 09~12시, 내일 오전 비 예보");
